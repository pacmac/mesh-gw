...
_FIELD_ANNOTATIONS: dict[str, dict] = {
    ...
    "telemetry.device_update_interval":                         {"unit": "seconds", "min": 1800, "hint": "min 1800 (firmware-enforced); 0 = use default (3600 s)"},
    "telemetry.environment_update_interval":                    {"unit": "seconds", "min": 1800, "hint": "min 1800 (firmware-enforced); 0 = use default (3600 s)"},
    "telemetry.air_quality_interval":                           {"unit": "seconds", "min": 1800, "hint": "min 1800 (firmware-enforced); 0 = use default (3600 s)"},
    "telemetry.power_update_interval":                          {"unit": "seconds", "min": 1800, "hint": "min 1800 (firmware-enforced); 0 = use default (3600 s)"},
    "telemetry.health_update_interval":                         {"unit": "seconds", "min": 1800, "hint": "min 1800 (firmware-enforced); 0 = use default (3600 s)"},
